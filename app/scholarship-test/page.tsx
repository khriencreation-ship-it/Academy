    ...
    <main className="px-4 lg:px-9 bg-black min-h-[80vh] flex flex-col items-center justify-center">
      <section className="text-center max-w-3xl mx-auto px-4 md:px-6">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-normal tracking-tight text-white leading-tight mb-4 md:mb-6">
          Scholarship Test <span className="text-[#934ab3]">Closed</span>
        </h1>
        <p className="text-base md:text-lg text-white/80 leading-relaxed mx-auto mb-8">
          Thank you for your interest! The scholarship test for the Genesis Cohort has officially closed. 
          We are no longer accepting submissions at this time. Stay tuned for updates on our next cohort.
        </p>
        <div className="flex justify-center">
          <Link
            href="/"
            className="group inline-flex items-center gap-2 bg-[#934ab3] text-white px-6 py-3 rounded-sm font-semibold hover:opacity-90 transition-opacity"
          >
            Return to Home
